...
;oled_control.c,348 :: 		led_addr = EEPROM_read(0);   //  4E,7E for 1602   or 78, 7A for OLED
...
;oled_control.c,350 :: 		if(led_type==0) {
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_Soft_I2C_Init72
;oled_control.c,351 :: 		Soft_I2C_Scl_Direction = 0;
	BCF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
;oled_control.c,352 :: 		Soft_I2C_Sda_Direction = 0;
	BCF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
;oled_control.c,353 :: 		Soft_I2C_Scl = 1;
	BSF         LATC6_bit+0, BitPos(LATC6_bit+0) 
;oled_control.c,354 :: 		Soft_I2C_Sda = 1;
	BSF         LATC7_bit+0, BitPos(LATC7_bit+0) 
;oled_control.c,355 :: 		}
	GOTO        L_Soft_I2C_Init73
L_Soft_I2C_Init72:
;oled_control.c,357 :: 		Soft_I2C_Scl_Direction = 1;
	BSF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
;oled_control.c,358 :: 		Soft_I2C_Sda_Direction = 1;
	BSF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
;oled_control.c,359 :: 		Soft_I2C_Scl = 0;
	BCF         LATC6_bit+0, BitPos(LATC6_bit+0) 
;oled_control.c,360 :: 		Soft_I2C_Sda = 0;
...
;oled_control.c,364 :: 		void Soft_I2C_Start () {
;oled_control.c,365 :: 		if(led_type!=0) {
	MOVF        oled_control_led_type+0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_Soft_I2C_Start74
;oled_control.c,366 :: 		Soft_I2C_Scl_Direction = 1;
	BSF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
...
L_Soft_I2C_Start75:
	...
	NOP
;oled_control.c,368 :: 		Soft_I2C_Sda_Direction = 1;
	BSF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
...
L_Soft_I2C_Start76:
	...
	NOP
;oled_control.c,370 :: 		Soft_I2C_Sda_Direction = 0;
	BCF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
...
L_Soft_I2C_Start77:
	...
	NOP
;oled_control.c,372 :: 		Soft_I2C_Scl_Direction = 0;
	BCF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
;oled_control.c,373 :: 		Delay_us(5);
	MOVLW       6
	MOVWF       R13, 0
L_Soft_I2C_Start78:
	DECFSZ      R13, 1, 1
...
;oled_control.c,377 :: 		void Soft_I2C_Write (char d) {
;oled_control.c,379 :: 		if(led_type!=0) {
	MOVF        oled_control_led_type+0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_Soft_I2C_Write79
;oled_control.c,380 :: 		for(i=0; i<=7; i++) {
	CLRF        R1 
L_Soft_I2C_Write80:
	MOVF        R1, 0 
	SUBLW       7
...
;oled_control.c,381 :: 		if(d.B7==0) Soft_I2C_Sda_Direction = 0; else  Soft_I2C_Sda_Direction = 1;
...
L_Soft_I2C_Write85:
	...
	NOP
;oled_control.c,383 :: 		Soft_I2C_Scl_Direction = 1;
	BSF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
...
L_Soft_I2C_Write86:
	...
	NOP
;oled_control.c,385 :: 		Soft_I2C_Scl_Direction = 0;
	BCF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
;oled_control.c,386 :: 		Delay_us(5);
	MOVLW       6
	MOVWF       R13, 0
L_Soft_I2C_Write87:
	DECFSZ      R13, 1, 1
...
L_Soft_I2C_Write81:
;oled_control.c,390 :: 		Soft_I2C_Sda_Direction = 1; //ACK
	BSF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
...
L_Soft_I2C_Write88:
	...
	NOP
;oled_control.c,392 :: 		Soft_I2C_Scl_Direction = 1;
	BSF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
...
L_Soft_I2C_Write89:
	...
	NOP
;oled_control.c,394 :: 		Soft_I2C_Scl_Direction = 0;
	BCF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
;oled_control.c,395 :: 		Delay_us(5);
	MOVLW       6
	MOVWF       R13, 0
L_Soft_I2C_Write90:
	DECFSZ      R13, 1, 1
...
;oled_control.c,399 :: 		void Soft_I2C_Stop () {
;oled_control.c,400 :: 		if(led_type!=0) {
	MOVF        oled_control_led_type+0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_Soft_I2C_Stop91
;oled_control.c,401 :: 		Soft_I2C_Sda_Direction = 0;
	BCF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
...
L_Soft_I2C_Stop92:
	...
	NOP
;oled_control.c,403 :: 		Soft_I2C_Scl_Direction = 1;
	BSF         TRISC6_bit+0, BitPos(TRISC6_bit+0) 
...
L_Soft_I2C_Stop93:
	...
	NOP
;oled_control.c,405 :: 		Soft_I2C_Sda_Direction = 1;
	BSF         TRISC7_bit+0, BitPos(TRISC7_bit+0) 
