...
#line 13 "C:/Users/Dietmar/Documents/git/N7DDC-ATU-100-mini-and-YT100/ATU_100_EXT_board/FirmWare_PIC18F2520/2520_YT100_sources_V_3.2/main.c"
...
void main() {
 ...
 void Tune_Button_proc_test(void) {
...
void lcd_pwr() {
 ...
 if(PORTB.B1==0 | PORTB.B2==0 | (PORTB.B0==0 & tune_btn_release)) {Tune_Button_delay(); if(but==1) {but = 0; return;} }
 get_pwr();
