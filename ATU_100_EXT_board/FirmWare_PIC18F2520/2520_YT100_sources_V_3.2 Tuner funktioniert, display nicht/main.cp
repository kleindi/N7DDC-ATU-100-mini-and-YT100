#line 1 "C:/Users/Dietmar/Documents/git/N7DDC-ATU-100-mini-and-YT100/ATU_100_EXT_board/FirmWare_PIC18F2520/2520_YT100_sources_V_3.2 Tuner funktioniert, display nicht/main.c"
#line 1 "c:/users/dietmar/documents/git/n7ddc-atu-100-mini-and-yt100/atu_100_ext_board/firmware_pic18f2520/2520_yt100_sources_v_3.2 tuner funktioniert, display nicht/oled_control.h"
...
#line 1 "c:/users/dietmar/documents/git/n7ddc-atu-100-mini-and-yt100/atu_100_ext_board/firmware_pic18f2520/2520_yt100_sources_v_3.2 tuner funktioniert, display nicht/pic_init.h"
#line 24 "c:/users/dietmar/documents/git/n7ddc-atu-100-mini-and-yt100/atu_100_ext_board/firmware_pic18f2520/2520_yt100_sources_v_3.2 tuner funktioniert, display nicht/pic_init.h"
...
void pic_init(void);
#line 1 "c:/users/dietmar/documents/git/n7ddc-atu-100-mini-and-yt100/atu_100_ext_board/firmware_pic18f2520/2520_yt100_sources_v_3.2 tuner funktioniert, display nicht/main.h"
...
void set_ind(char Ind) {
 if(L_invert == 0) {
 if(Ind.B0) Set_Relais( 1 ); else Reset_Relais( 1 );
 if(Ind.B1) Set_Relais( 2 ); else Reset_Relais( 2 );
 if(Ind.B2) Set_Relais( 3 ); else Reset_Relais( 3 );
 if(Ind.B3) Set_Relais( 4 ); else Reset_Relais( 4 );
 if(Ind.B4) Set_Relais( 5 ); else Reset_Relais( 5 );
 if(Ind.B5) Set_Relais( 6 ); else Reset_Relais( 6 );
 if(Ind.B6) Set_Relais( 7 ); else Reset_Relais( 7 );
 if(Ind.B7) Set_Relais( 8 ); else Reset_Relais( 8 );
 }
 else {
 if(Ind.B0) Reset_Relais( 1 ); else Set_Relais( 1 );
 if(Ind.B1) Reset_Relais( 2 ); else Set_Relais( 2 );
 if(Ind.B2) Reset_Relais( 3 ); else Set_Relais( 3 );
 if(Ind.B3) Reset_Relais( 4 ); else Set_Relais( 4 );
 if(Ind.B4) Reset_Relais( 5 ); else Set_Relais( 5 );
 if(Ind.B5) Reset_Relais( 6 ); else Set_Relais( 6 );
 if(Ind.B6) Reset_Relais( 7 ); else Set_Relais( 7 );
 if(Ind.B7) Reset_Relais( 8 ); else Set_Relais( 8 );
 }
}

void set_cap(char Cap) {
 if(Cap.B0) Set_Relais( 9 ); else Reset_Relais( 9 );
 if(Cap.B1) Set_Relais( 10 ); else Reset_Relais( 10 );
 if(Cap.B2) Set_Relais( 11 ); else Reset_Relais( 11 );
 if(Cap.B3) Set_Relais( 12 ); else Reset_Relais( 12 );
 if(Cap.B4) Set_Relais( 13 ); else Reset_Relais( 13 );
 if(Cap.B5) Set_Relais( 14 ); else Reset_Relais( 14 );
 if(Cap.B6) Set_Relais( 15 ); else Reset_Relais( 15 );
}
...
#line 11 "C:/Users/Dietmar/Documents/git/N7DDC-ATU-100-mini-and-YT100/ATU_100_EXT_board/FirmWare_PIC18F2520/2520_YT100_sources_V_3.2 Tuner funktioniert, display nicht/main.c"
...
void lcd_swr(int swr) {
 ...
 if(swr<=150) { Soft_I2C_Scl = 0; Soft_I2C_Sda = 1; }
 else if(swr<=250) {Soft_I2C_Scl = 0; PORTB.B7 = 0;}
 else { Soft_I2C_Scl = 1; Soft_I2C_Sda = 0; }
 }
 }
 }
 asm CLRWDT;
...
void cells_init(void) {
 ...
 Ind8 = Bcd2Dec(EEPROM_Read(30)) * 100 + Bcd2Dec(EEPROM_Read(31));
