...
void set_ind(char Ind) {
   if(L_invert == 0) {
      if(Ind.B0) Set_Relais(REL_L1); else Reset_Relais(REL_L1);
      if(Ind.B1) Set_Relais(REL_L2); else Reset_Relais(REL_L2);
      if(Ind.B2) Set_Relais(REL_L3); else Reset_Relais(REL_L3);
      if(Ind.B3) Set_Relais(REL_L4); else Reset_Relais(REL_L4);
      if(Ind.B4) Set_Relais(REL_L5); else Reset_Relais(REL_L5);
      if(Ind.B5) Set_Relais(REL_L6); else Reset_Relais(REL_L6);
      if(Ind.B6) Set_Relais(REL_L7); else Reset_Relais(REL_L7);
      if(Ind.B7) Set_Relais(REL_L8); else Reset_Relais(REL_L8);
   }
   else {
      if(Ind.B0) Reset_Relais(REL_L1); else Set_Relais(REL_L1);
      if(Ind.B1) Reset_Relais(REL_L2); else Set_Relais(REL_L2);
      if(Ind.B2) Reset_Relais(REL_L3); else Set_Relais(REL_L3);
      if(Ind.B3) Reset_Relais(REL_L4); else Set_Relais(REL_L4);
      if(Ind.B4) Reset_Relais(REL_L5); else Set_Relais(REL_L5);
      if(Ind.B5) Reset_Relais(REL_L6); else Set_Relais(REL_L6);
      if(Ind.B6) Reset_Relais(REL_L7); else Set_Relais(REL_L7);
      if(Ind.B7) Reset_Relais(REL_L8); else Set_Relais(REL_L8);
   }
}

void set_cap(char Cap) {
   if(Cap.B0) Set_Relais(REL_C1); else Reset_Relais(REL_C1);
   if(Cap.B1) Set_Relais(REL_C2); else Reset_Relais(REL_C2);
   if(Cap.B2) Set_Relais(REL_C3); else Reset_Relais(REL_C3);
   if(Cap.B3) Set_Relais(REL_C4); else Reset_Relais(REL_C4);
   if(Cap.B4) Set_Relais(REL_C5); else Reset_Relais(REL_C5);
   if(Cap.B5) Set_Relais(REL_C6); else Reset_Relais(REL_C6);
   if(Cap.B6) Set_Relais(REL_C7); else Reset_Relais(REL_C7);
}
